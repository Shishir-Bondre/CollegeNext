                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper  table-responsive">
                                <table class="table table-striped table-bordered table-hover a7" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                    $home=mysql_query("SELECT * FROM `home_m_open` WHERE university = '$university' AND round_1_s >= '$rank' AND round_1m_s <= '$mark' ");
												$state=mysql_query("SELECT * FROM `state_m_open` WHERE  round_1_s >= '$rank' AND round_1m_s <= '$mark'");
												$i=1;
