...
<head>
		...
		<title>CollegeNext | Find College</title>
		
 		<meta charset="utf-8">
    	<meta http-equiv="X-UA-Compatible" content="IE=edge">
   	<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="description" content="College Suggestor Engine : Get the Prediction of the Best college  ">
					...
					<div class="row">
							<div class="col-md-12">
                        		...
                        		<h1 class="a3">College-NeXT</h1>
                    			 ...
                    			 <div class="panel-body">
                    			 	  <form role="form" method="post" action="engg_find/direct.php">
                            			<?php
                            			$_SESSION['findcollege']=1;
                            			?>
													 	
														
													<div class="form-group a3">
													<label for="marks"> By Marks : </label>
													<input class="form-control input-lg"   name='mark' placeholder='Enter your CET Marks Out of 200 ' />
													 </div> 	
													 <div class="form-group a3">
													 <label > OR : </label>
													 </div>
													 <div class="form-group a3">
													<label for="rank"> By Rank : </label>
													<input class="form-control input-lg"   name='rank' placeholder='Enter your STATE GENERAL RANK '  />
													 </div> 
