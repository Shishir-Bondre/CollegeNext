      							...
      							<?					               		
											if(isset($_POST['submit']))
											{
												...
												$j =1;
 												...
 												$home=mysql_query("SELECT * FROM `home_m_nt2` WHERE  `college_name`='$college_name' AND `branch`= '$branch[$i]'  AND `round_2m_s` <= '$mark'");
												...
												$state=mysql_query("SELECT * FROM `state_m_nt2` WHERE `college_name`='$college_name' AND `branch`='$branch[$i]' AND `round_2m_s` <= '$mark'");
