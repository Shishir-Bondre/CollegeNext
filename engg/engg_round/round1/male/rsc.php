      							...
      							<?					               		
											if(isset($_POST['submit']))
											{
												...
												$j =1;
 												...
 												$home=mysql_query("SELECT * FROM `home_m_sc` WHERE  `college_name`='$college_name' AND `branch`= '$branch[$i]'  AND `round_1m_s` <= '$mark'");
												...
												$state=mysql_query("SELECT * FROM `state_m_sc` WHERE `college_name`='$college_name' AND `branch`='$branch[$i]' AND `round_1m_s` <= '$mark'");
