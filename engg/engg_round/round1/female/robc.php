      							...
      							<?					               		
											if(isset($_POST['submit']))
											{
												...
												$j =1;
 												...
 												$home=mysql_query("SELECT * FROM `home_f_obc` WHERE  `college_name`='$college_name' AND `branch`= '$branch[$i]'  AND `round_1m_s` <= '$mark'");
												...
												$state=mysql_query("SELECT * FROM `state_f_obc` WHERE `college_name`='$college_name' AND `branch`='$branch[$i]' AND `round_1m_s` <= '$mark'");
